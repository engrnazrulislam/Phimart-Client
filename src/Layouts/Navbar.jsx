    ...
    return (
        ...
        <div className="navbar-start">
            ...
            <ul
                ...
                <li><NavLink to={'/'} className={({isActive})=> isActive ? "btn btn-primary btn-soft":""}>Home</NavLink></li>
                <li>
                <NavLink to={'/product'} className={({isActive})=> isActive ? "btn btn-primary btn-soft":""}>Product</NavLink>
                {/* <ul className="p-2">
                    <li><a>Submenu 1</a></li>
                    <li><a>Submenu 2</a></li>
                </ul> */}
